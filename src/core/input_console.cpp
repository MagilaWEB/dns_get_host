...
size_t InputConsole::selectFromList(const Type& list, std::function<void(size_t)>&& callback)
{
...
template CORE_API size_t InputConsole::selectFromList<std::list<std::string>>(const std::list<std::string>&, std::function<void(size_t)>&&);
template CORE_API size_t InputConsole::selectFromList<std::vector<std::string>>(const std::vector<std::string>&, std::function<void(size_t)>&&);
